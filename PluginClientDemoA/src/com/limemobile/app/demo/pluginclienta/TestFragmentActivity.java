...
implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(mContext, getIntent().getStringExtra("dl_extra"), Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        if (v == mShowFragmentButton) {
            ...
            PluginClientManager.sharedInstance(mContext).startPluginClientActivity(mContext, "com.limemobile.app.demo.pluginclientb", ".MainActivity");
        }
