...
public class PluginDelegateContentProviderImpl {
    ...
    public void onCreate(Intent intent) {
        ...
        mPluginManager = PluginClientManager.sharedInstance(mPluginHostContentProvider.getContext());
    ...
    protected void launchTargetContentProvider() {
        try {
            ...
            mDelegatedContentProvider.setDelegate(mPluginHostContentProvider, mPluginClient);
